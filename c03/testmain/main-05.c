...
int main() {
    ...
    // ---------------------------------------------------------
    {
        ...
        unsigned int ret = ft_strlcat(dest, src, sizeof(dest));
    ...
    // ---------------------------------------------------------
    {
        ...
        unsigned int ret = ft_strlcat(dest, src, 3);
    ...
    // ---------------------------------------------------------
    {
        ...
        unsigned int ret = ft_strlcat(dest, src, 5);
    ...
    // ---------------------------------------------------------
    {
        ...
        unsigned int ret = ft_strlcat(dest, src, 0);
    ...
    printf("All ft_strlcat tests passed successfully!\n");
    return 0;
}
