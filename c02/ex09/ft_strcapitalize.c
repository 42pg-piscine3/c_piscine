...
/*   Updated: 2026/07/01 01:09:33 by joshtan          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
if (result_ptr == NULL)
{
printf("[PASS] Function safely handled NULL pointer and returned NULL.\n\n");
}
else
{
printf("[FAIL] Function did not return NULL when given a NULL pointer.\n\n");
}
